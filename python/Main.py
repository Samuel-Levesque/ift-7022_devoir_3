...
if __name__ == '__main__':
    ...
    if bool_faire_test_meilleur_model:
        ...
        X_train,X_test =create_X_from_dict_parameters(dictionnaire_meilleur_parametres,corpus_train,corpus_test,bool_ajouter_autres_features)
    ...
    if bool_faire_prediction:
        ...
        X_train, X_test = create_X_from_dict_parameters(dictionnaire_meilleur_parametres, corpus, corpus_sans_labels,bool_ajouter_autres_features)
        ...
        print(pd.DataFrame({"Corpus test":corpus_sans_labels,"Label prédit":labels_pred}))
